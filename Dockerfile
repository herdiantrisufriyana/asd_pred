...
RUN R -e "BiocManager::install('readxl', version = '3.20', ask=FALSE, update=FALSE, force=TRUE)"
RUN R -e "BiocManager::install('MASS', version = '3.20', ask=FALSE, update=FALSE, force=TRUE)"
